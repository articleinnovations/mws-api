...
const Finances = require('./sections/finances');
const Subscriptions = require('./sections/subscriptions');
...
module.exports = function (context) {
    ...
    return {
        ...
        Finances: createRequestsBound(Finances),
        ...
        Subscriptions: createRequestsBound(Subscriptions),
